...
from patchgan.io import FloatingForestsDataset, COCOStuffDataset
...
if __name__ == '__main__':
    ...
    dataset_kwargs = {}
    if config['dataset']['type'] == 'FloatingForests':
        Dataset = FloatingForestsDataset
        in_channels = 4
        out_channels = 1
    elif config['dataset']['type'] == 'COCOStuff':
